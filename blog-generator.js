...
const REVIEW_TOPICS = [
  ...
  {
    slug: '99-rental-review-crab-island-day',
    title: 'Rental Review: Crab Island Days Are Better on a $99/Day Golf Cart',
    excerpt: 'A customer review of pairing a $99/day street-legal golf cart with Crab Island days in Destin — easy Harbor runs, easy parking, zero stress.',
    image: 'images/cart-4seat.webp',
    keywords: 'Crab Island golf cart, golf cart rental Crab Island Destin, Crab Island Destin FL, Destin Harbor golf cart rental, golf cart to Crab Island shuttle',
    intro: 'Crab Island is the highlight of every Destin trip, and this customer says the $99/day golf cart made the whole day effortless from door to dock.',
    body: 'We rode from our Miramar Beach rental to the Destin Harbor in the cart, grabbed the shuttle to Crab Island, and came back to a cart that was still charged and ready for dinner on the Boardwalk. Parking at the Harbor in July was the easiest part of our whole trip because of the cart. $99 a day felt like a steal.',
    rating: 5,
  },
  {
    slug: '99-rental-review-henderson-beach',
    title: 'Rental Review: Henderson Beach State Park on a $99/Day Golf Cart',
    excerpt: 'Review of a week in Destin with a $99/day golf cart — daily rides to Henderson Beach State Park, easy packing, free delivery.',
    image: 'images/rover-xl6-white.jpg',
    keywords: 'Henderson Beach State Park golf cart, golf cart rental Destin beach, Henderson Beach FL, Destin state park parking, golf cart beach days Destin',
    intro: 'Henderson Beach State Park has some of the whitest sand on the Gulf, and this reviewer says the cart made every beach day a five-minute affair.',
    body: 'Every morning we packed chairs and the cooler in the cart and cruised to the Henderson Beach entrance — no car seats to fight, no parking ramp, no hot car waiting. The cart was delivered free on our 4+ day rental, spotless, and the 4 seats fit our whole crew. Booking by text at 10pm was a bonus.',
    rating: 5,
  },
  {
    slug: '99-rental-review-grand-boulevard',
    title: 'Rental Review: Grand Boulevard Dinners and Shopping on a $99/Day Cart',
    excerpt: 'A Miramar Beach customer reviews using the $99/day golf cart for dinners and shopping at Grand Boulevard Town Center — no parking lots, ever.',
    image: 'images/cart-4seat.webp',
    keywords: 'Grand Boulevard Miramar Beach, golf cart Grand Boulevard Town Center, Miramar Beach shopping golf cart, dinner Grand Boulevard Destin, golf cart rental reviews Miramar Beach',
    intro: 'Grand Boulevard Town Center is Miramar Beach\u2019s favorite dinner-and-shopping stop, and a street-legal cart turns the parking lot hunt into a two-minute park.',
    body: 'We stayed in Miramar Beach and used the cart for every Grand Boulevard night — dinner, the shops, and Friday concerts on the green. The cart parked right up front every single time. Delivery was free and on time, the cart was clean and charged, and the whole thing cost $99 a day. Easily the best money we spent on the trip.',
    rating: 5,
  },
];
